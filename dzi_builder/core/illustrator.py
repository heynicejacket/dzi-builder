...
def ai_to_svg(app, layer_path, verbose=False):
    ...
    and returns a list of the file name groups. For example, a folder which contains:
    ...
    layer_name_list = [f.strip('.ai') for f in rem_list_pre]
